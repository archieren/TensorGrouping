...
class RSU6(KL.Layer):
    ...
    def call(self, x):
        ...
        hor_x_3, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_4, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_5, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x, pooling=False)
...
class RSU5(KL.Layer):
    ...
    def call(self, x):
        ...
        hor_x_2, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_3, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_4, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x, pooling=False)
...
class RSU4(KL.Layer):
    ...
    def call(self, x):
        ...
        hor_x_1, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_2, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x)
        hor_x_3, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x, pooling=False)
...
class RSU4F(KL.Layer):
    ...
    def call(self, x):
        ...
        hor_x_1, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=1), down_x, pooling=False)
        hor_x_2, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=2), down_x, pooling=False)
        hor_x_3, down_x = down_RBC_with(RBC(filters=self.mid_filters, dilation_rate=4), down_x, pooling=False)

        up_x = RBC(filters=self.mid_filters, dilation_rate=8)(down_x)

        up_x = up_RBC_with(RBC(filters=self.mid_filters, dilation_rate=4), hor_x_3, up_x, upsampling=False)
        up_x = up_RBC_with(RBC(filters=self.mid_filters, dilation_rate=2), hor_x_2, up_x, upsampling=False)
        up_x = up_RBC_with(RBC(filters=self.filters, dilation_rate=1), hor_x_1, up_x, upsampling=False)
